...
<!-- Database -->
<link rel="stylesheet" href="php/superlogindb.php">
  ...
  <section id="SuperLoginPage">
    <div class="container">
      <div class="row">
         ...
         <div class="col">
          <form method="post" action="login.php" class="log-box">
        ...
        <?php  } ?>
                ...
                <button  type="submit" id="submitData" name="submitData" class="registerbtn">Login</button>
        </form>
      </div>
  </div>
  </section> 
